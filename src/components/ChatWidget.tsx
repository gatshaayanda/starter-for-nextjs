...
const INTENTS = [
  ...
  },
  {
    ...
    respond: () =>
      reply(pick(tone.pricing), [SUGG.PRICING, SUGG.DOCS, SUGG.CONSOLE]),
  },
  {
    name: "docs",
    weight: 4,
    ...
    respond: () =>
      reply(pick(tone.docs), [SUGG.DOCS, SUGG.CONSOLE, SUGG.GITHUB]),
  },
  {
    name: "console",
    weight: 4,
    ...
    respond: () =>
      reply(pick(tone.console), [SUGG.CONSOLE, SUGG.DOCS, SUGG.PRICING]),
  },
  {
    name: "github",
    weight: 3,
    ...
    respond: () =>
      reply(pick(tone.github), [SUGG.GITHUB, SUGG.OPEN_SOURCE, SUGG.DOCS]),
  },
];
